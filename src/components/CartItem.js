...
//destruktur item
  ...
  return (
  <div>
    <div className='flex gap-x-4 py-2 lg:px-6 border-b border-gray-2- w-full font-light text-gray-500'>
      ...
      <div className='w-full min-h-[150px] flex items-center gap-x-4'>
        ...
        text-sm'>
          ...
          <div className='flex flex-1 max-w[100px] items-center h-full border text-primary font-medium'>
            ...
            {/* plus icon*/}
            <div onClick={()=> increaseAmount(id)}className='flex-1 h-full flex justify-center items-center cursor pointer'><IoMdAdd/>
            </div>
